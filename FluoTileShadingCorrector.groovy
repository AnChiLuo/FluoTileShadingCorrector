...
// Author: An-Chi, Luo
// Date: [2025-06-11]
// Note: use BigStitcher to stitch Tiles and build a xml creator (Clean code), Lif file is accetable
//
// Description:
...
if (absoluteF.size() >1 && absoluteF.size() == nTiles){
    ...
    Map <String, Number > unitConversion =["m":1000000 , "mm": 1000, "nm" : 0.001, "cm": 10000, "μm":1.0] 
